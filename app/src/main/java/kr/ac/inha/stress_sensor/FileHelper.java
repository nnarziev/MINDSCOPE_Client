    ...
    public static void submitSensorData(final Context context) {
        ...
        if (Tools.isNetworkAvailable(context)) {
            ...
            for (int n = 0; n < fileNamesInLong.size() - 1; n++) {
                ...
                String url = context.getString(R.string.url_sensor_data_submit, context.getString(R.string.grpc_host));
                String email = loginPrefs.getString(AuthenticationActivity.user_id, null);
                String password = loginPrefs.getString(AuthenticationActivity.usrEmail, null);
