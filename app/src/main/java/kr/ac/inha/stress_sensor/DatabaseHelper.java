...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COL_3 = "VALUE";
    private static final String COL_4 = "CHECK_DELETE";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + SMARTPHONE_SENSOR_TABLE +
                ...
                COL_2 + " BIGINT DEFAULT(0), " +
                COL_3 + " TEXT DEFAULT(0), " +
    ...
    public synchronized void insertSensorData(int data_src, long timestamp, String value) {
    ...
    public List<String[]> getSensorData() {
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("select * from " + SMARTPHONE_SENSOR_TABLE + " where " + COL_4 + "=?;", new String[]{"true"});
    ...
    public void deleteSensorData() {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(SMARTPHONE_SENSOR_TABLE, COL_4 + " = ?", new String[]{"true"});
    }
